					...
					><div id="tickets" class="ticket">
						...
						<v-card-text>
							...
							<v-row style="padding-top: 5px;" v-if="total > 0">
								<v-col class="finalTicket" align="right">
									<h3>Total:</h3>
									<h2>${{ total }}</h2>
								</v-col>
							</v-row>
							...
							<!-- CAMBIO -->
							<v-row>
								<v-col align="right" class="cambio">
									<h3>Cambio:</h3>
									<h2>${{ cambio }}</h2>
								</v-col>
							</v-row>
	...
	export default {
		...
		methods: {
			...
			async crearPDF() {
				 ...
				 var contenido = document.getElementById("tickets").innerHTML;
